const { SPLBaselineFunction } = require("../utils/SplBaselineForm");
...
module.exports = async function (context, req) {
  ...
  try {
    ...
    const data = {
      text: `Error in SPL Baseline Form submissionId ${formData.submissionId}, form ${formData.xmlFormId} instance Id - "${formData.instanceId}", created at - "${formData.createdAt}"  \n Error: ${error} `,
    };
