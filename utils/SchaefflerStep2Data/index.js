...
const SchaefflerStep2Function = async (formData) => {
    try {
        ...
        if(form.length > 0){
            ...
            const runnerData = {
                ...
                projectName: "Swaasthya Jyoti Baseline Form",
            ...
            airtableData['Filled Time'] = createdAt;
...
module.exports = { SchaefflerStep2Function };