...
const BioCNGFunction = async (formData) => {
    try {
        ...
        if(form.length > 0){
            ...
            const runnerData = {
                ...
                projectName: "BioCNG Survey (Teri)",
            ...
            if(insertDatainDb[0])  runnerData.table_name = "bio_cng_duplicate_data";
