...
const SuniyeNetajiFunction = async (formData) => {
    try {
        ...
        if(form.length > 0){
            ...
            formFields["If_Postcard_Blank_Postcard_Photo"] = "binary";
            formFields["Click_the_met_person_photo_with_Postcard"] = "binary";
            formFields["If_Postcard_Click_Filled_Postcard_Photo"] = "binary";
            ...
            //remove  <Filled_By_Email_Id> from <Filled_By_Email_Id>support55&#64;anaxee.com</Filled_By_Email_Id>
            finalParsedData["Filled_by_Email"] = finalParsedData["Filled_by_Email"].split(">")[1].split("<")[0];
            //replace &#64 with @
            finalParsedData["Filled_by_Email"] = finalParsedData["Filled_by_Email"].replace(/&#64;/g, '@');
            };

            
            console.log('finalParsedData', finalParsedData);

            const contact_number = finalParsedData.Met_Person_Mobile_Number;
            ...
            const runnerData = {
                ...
                projectName: "Suniye Netaji - Aaj Tak",
...
module.exports = { SuniyeNetajiFunction };