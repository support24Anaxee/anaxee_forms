...
const IMPCASaplingMonitoringFunction = async (formData) => {
    try {
        ...
        if(form.length > 0){
            ...
            const runnerData = {
                ...
                projectName: "IMPCA Sapling Monitoring Survey",
                ...
                table_name: "impca_sapling_monitoring_data"
            }
...
module.exports = { IMPCASaplingMonitoringFunction };